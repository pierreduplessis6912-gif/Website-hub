...
.hero-rating{position:absolute;top:76px;right:20px;background:rgba(255,255,255,.12);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.2);border-radius:14px;padding:12px 14px;text-align:center;z-index:2;animation:fadeIn 1s 1.2s ease both;min-width:80px}
